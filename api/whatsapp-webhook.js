...
Phone: +91 97845 32400. Email: contact@navthera.in.
...
async function getAssistantReply(message) {
  ...
  return result.choices?.[0]?.message?.content?.trim() || 'I am sorry, I could not answer that. Please call us at +91 97845 32400.';
}
