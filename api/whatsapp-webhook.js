...
Phone: +91 91160 32400. Email: contact@navthera.in.
...
async function getAssistantReply(message) {
  ...
  return result.choices?.[0]?.message?.content?.trim() || 'I am sorry, I could not answer that. Please call us at +91 91160 32400.';
}
